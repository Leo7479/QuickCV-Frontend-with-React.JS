const Footer = ()=>{
    return(
        <footer className="w-full h-fit bg-dark py-20 mt-20">
            <div className="py-4 max-[1920px]:px-2 w-full h-fit flex flex-col md:flex-row text-aliceBlue justify-start md:justify-around items-start max-w-[1440px] mx-auto">
